    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 animate-fade-in">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md animate-slide-up">
        <div className="flex items-center justify-between px-6 py-4 border-b border-navy-100">
          <h2 className="text-lg font-semibold text-navy-800">{isEdit ? 'Editar Usuario' : 'Nuevo Usuario'}</h2>
        ...
        <form onSubmit={handleSubmit((d) => mutation.mutate(d))} className="p-6 space-y-4">
          <div>
            <label className="block text-sm font-medium text-navy-600 mb-1">Nombre completo *</label>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-sm font-medium text-navy-600 mb-1">Rol *</label>
          ...
          <div>
            ...
            <div className="flex rounded-lg border border-navy-200 overflow-hidden text-sm font-medium">
