...
import { Building2, CalendarDays, Plus, Save, Trash2, Pencil, X } from 'lucide-react';
...
const emptyHolidayForm = {
  ...
  scope: 'local' as 'national' | 'regional' | 'local' | 'company',
};
            ...
            {selectedBranch && (
              <div className="flex gap-2 pt-1">
                ...
                <button
                  ...
                  disabled={!selectedBranch.isActive}
            ...
            <>
              ...
              <div className="flex gap-2">
                <select
                  ...
                  onChange={(e) => setHolidayForm((prev) => ({ ...prev, scope: e.target.value as typeof prev.scope }))}
                >
                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="bg-theme-surface-muted border-b border-theme-color">
                        ...
                        <th className="text-left px-4 py-2.5 text-xs text-theme-muted uppercase">Ámbito</th>
                    ...
                    <tbody className="divide-y divide-theme-color">
                      {holidays.data.map((holiday) => (
                        <tr key={holiday.id} className="hover:bg-theme-surface-muted/60 transition-colors">
                          ...
                          <td className="px-4 py-2.5 text-xs text-theme-muted uppercase">{holiday.scope}</td>
                          <td className="px-4 py-2.5">
