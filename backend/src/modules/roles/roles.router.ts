...
router.get('/permissions', authMiddleware, requirePermission('settings:manage'), (req: AuthRequest, res: Response) => ctrl.listPermissionsController(req, res));
router.get('/', authMiddleware, requirePermission('settings:manage'), (req: AuthRequest, res: Response) => ctrl.listRolesController(req, res));
router.get('/:id', authMiddleware, requirePermission('settings:manage'), (req: AuthRequest, res: Response) => ctrl.getRoleController(req, res));
